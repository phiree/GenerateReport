...
class Application(tk.Frame):
    ...
    def createWidgets(self):
        self.lbl_title=tk.Label(self,text='Reports of Sales,Customers,AccountReceiveable:')
    ...
    def generate_report(self):
        ...
        try:
            Generator.ReportGenerator(date_start,date_end,'Sale_Report').generate_reports()
            Generator.ReportGenerator(date_start,date_end,'Customer_Report').generate_reports()
            Generator.ReportGenerator(date_start,date_end,'Account_Receivable_Report').generate_reports()
